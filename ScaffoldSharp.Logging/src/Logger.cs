using System;
using ScaffoldSharp.Logging.Impl;
...
namespace ScaffoldSharp.Logging
{
    ...
    {
        /// <summary>
        /// Program-wide log message prefix
        /// </summary>
        public static string GlobalMessagePrefix = "";

        /// <summary>
        /// Active implementation provider, override to use a different implementation
        /// </summary>
        protected static ILoggerImplementationProvider provider = new DefaultConsoleLoggerImpl();
